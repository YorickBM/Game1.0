...
public class WaterRenderer {
	...
	private final WaterShaderLowPoly shader;
	...
	public WaterRenderer() {
		this.shader = new WaterShaderLowPoly();
	}
	 ...
	 */
	public void render(WaterTileLowPoly water, ICamera camera, LightLowPoly light, int reflectionTexture, int refractionTexture,
			int depthTexture) {
	 ...
	 *            - The scene's light.
	 */
	private void prepare(WaterTileLowPoly water, ICamera camera, LightLowPoly light) {
		water.getVao().bind();
	...
	private void bindTextures(int reflectionTexture, int refractionTexture, int depthTexture) {
		bindTextureToUnit(reflectionTexture, WaterShaderLowPoly.REFLECT_TEX_UNIT);
		bindTextureToUnit(refractionTexture, WaterShaderLowPoly.REFRACT_TEX_UNIT);
		bindTextureToUnit(depthTexture, WaterShaderLowPoly.DEPTH_TEX_UNIT);
	}
	 ...
	 *            - The light in the scene.
	 */
	private void prepareShader(WaterTileLowPoly water, ICamera camera, LightLowPoly light) {
		shader.start();
		updateTime();
	 ...
	 *            - The light source.
	 */
	private void loadLightVariables(LightLowPoly light) {
