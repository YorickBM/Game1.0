...
public class Player1 {
	...
	public void input(Window window){
		...
		if(window.isKeyDown(GLFW_KEY_SPACE) && onGround){
			yMotion = 0.26f;
		}
	}
	...
	public void mouseLook(Window window){
		//if(Mouse.isGrabbed()){ < Is not working in LWJGl 3
			float mouseDX = (float) (window.getMouseX() * 0.8f * 0.16f);
			float mouseDY = (float) (window.getMouseY() * 0.8f * 0.16f);
