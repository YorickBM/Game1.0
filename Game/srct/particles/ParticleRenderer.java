...
public class ParticleRenderer {
	...
	protected void render(Map<ParticleTexture, List<Particle>> particles, Camera camera){
		...
		for(ParticleTexture texture: particles.keySet()) {
			...
			for(Particle particle : particleList) {
				updateModelMatrix(particle.getPosition(), particle.getRotation(), particle.getScale(), viewMatrix, vboData);
	...
	private void updateModelMatrix(Vector3f position, float rotation, float scale, Matrix4f viewMatrix, float[] vboData) {
