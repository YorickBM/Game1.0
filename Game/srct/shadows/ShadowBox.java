...
public class ShadowBox {
	...
	private CameraLowPoly cam;
	private Camera camera;
	
	private boolean LowPolyCam = false;
	...
	protected ShadowBox(Matrix4f lightViewMatrix, Camera camera) {
		...
		this.camera = camera;
		this.LowPolyCam = false;
		calculateWidthsAndHeights();
	}
	
	protected ShadowBox(Matrix4f lightViewMatrix, CameraLowPoly camera) {
		this.lightViewMatrix = lightViewMatrix;
		this.cam = camera;
		this.LowPolyCam = true;
		calculateWidthsAndHeights();
	}
