...
public class ShaderProgramLowPoly {

	private int programID;

	public ShaderProgramLowPoly(MyFile vertexFile, MyFile fragmentFile, String... inVariables) {
	...
	public ShaderProgramLowPoly(MyFile vertexFile, MyFile geometryFile, MyFile fragmentFile, String... inVariables) {
		int vertexShaderID = loadShader(vertexFile, GL20.GL_VERTEX_SHADER);
