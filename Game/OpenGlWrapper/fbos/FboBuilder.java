...
public class FboBuilder {
	...
	/**Adds a color attachment to the FBO that is being created.
	 * @param index - The index of the color buffer that this attachment should be attached to.
	...
	/**
	 * Initializes and attaches all the colour attachments for this FBO.
	 */
