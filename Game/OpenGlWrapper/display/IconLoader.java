...
public class IconLoader {
	...
	public static GLFWImage.Buffer load(MyFile file16, MyFile file32, MyFile file128) {
		...
		try ( GLFWImage.Buffer icons = GLFWImage.malloc(2) ) {
			 ByteBuffer pixels16 = stbi_load_from_memory(buffers[0], w, h, comp, 4);
			    icons
			        .position(0)
			        .width(w.get(0))
			        .height(h.get(0))
			    ...
			    ByteBuffer pixels32 = stbi_load_from_memory(buffers[1], w, h, comp, 4);
			    icons
			        .position(1)
			        .width(w.get(0))
			        .height(h.get(0))
			    ...
			    ByteBuffer pixels128 = stbi_load_from_memory(buffers[2], w, h, comp, 4);
			    icons
			        .position(1)
			        .width(w.get(0))
			        .height(h.get(0))
