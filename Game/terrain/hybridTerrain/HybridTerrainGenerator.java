...
import rendering.TerrainShaderLowPoly;
...
public class HybridTerrainGenerator extends TerrainGenerator {
	...
	public HybridTerrainGenerator(PerlinNoise perlinNoise, ColourGenerator colourGen, String filePath) {
		super(perlinNoise, colourGen, filePath);
		this.renderer = new TerrainRendererLowPoly(new TerrainShaderLowPoly(VERTEX_SHADER, FRAGMENT_SHADER), true);
	}
	...
	@Override
	protected TerrainLowPoly createTerrain(float[][] heights, Colour[][] colours) {
		...
		return new TerrainLowPoly(vao, indices.length, renderer);
	}
