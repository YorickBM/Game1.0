...
public class TerrainRendererLowPoly {
	 ...
	 *            buffer or not.
	 */
	public TerrainRendererLowPoly(TerrainShaderLowPoly shader, boolean usesIndices) {
		this.shader = shader;
	 ...
	 */
	public void render(TerrainLowPoly terrain, ICamera camera, LightLowPoly light, Vector4f clipPlane) {
	 ...
	 *            that is rendered outside of the plane.
	 */
	private void prepare(TerrainLowPoly terrain, ICamera camera, LightLowPoly light, Vector4f clipPlane) {
		terrain.getVao().bind();
		shader.start();
